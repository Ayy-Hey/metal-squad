...
public class LaserGunProfile : WeaponProfile
{
	public LaserGunProfile(string demo = "")
	{
		this.Total_Bullet_Profile = new IntProfileData("rambo.weapon.profile.totalbullet" + this.name + "1.0.4" + demo, 25);
		...
		this.Gun_Value = new LaserValue();
	}

	private string name = "LaserGun";
}

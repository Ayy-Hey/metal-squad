...
{
	public ShotgunProfile(string demo = "")
	{
		this.Total_Bullet_Profile = new IntProfileData("rambo.weapon.profile.totalbullet" + this.name + "1.0.4" + demo, 32);
		...
		this.Gun_Value = new SpreadValue();
	}

...
namespace Player
{
	public class M4A1GunPlayer : RamboWeapon
	{
		public override void OnInit(WeaponProfile weaponProfile, PlayerMain inputPlayer)
		{
			base.OnInit(weaponProfile, inputPlayer);
			this.bone1 = this.player._PlayerSpine.FindBone("GunTip_M4A1-1");
			this.bone2 = this.player._PlayerSpine.FindBone("GunTip_M4A1-2");

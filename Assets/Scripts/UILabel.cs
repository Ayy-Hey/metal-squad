...
public class UILabel : UIWidget
{
	...
	private static void OnFontChanged(Font font)
	{
		...
		{
			int j = 0;
			int count = UILabel.mTempPanelList.Count;
			while (j < count)
			{
	...
	protected override void OnEnable()
	{
		...
		if (!UILabel.mTexRebuildAdded)
		{
			...
			{
				UILabel._003C_003Ef__mg_0024cache0 = new Action<Font>(UILabel.OnFontChanged);
			}
			Font.textureRebuilt += UILabel._003C_003Ef__mg_0024cache0;
		}
	}

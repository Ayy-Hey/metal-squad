...
namespace SWS
{
	...
	public class splineMove : MonoBehaviour
	{
		...
		private void CreateTween()
		{
			...
			this.state = splineMove.MoveState.PLAYING;
		}
		...
		private void ReachedEnd()
		{
			...
			case splineMove.LoopType.none:
				this.state = splineMove.MoveState.STOP;
		...
		public void Pause(float seconds = 0f)
		{
			...
			if (seconds > 0f)
			{
				this.state = splineMove.MoveState.PAUSE;
		...
		public void SetPath(PathManager newPath)
		{
			...
			this.loopType = newPath.loopType;
		...
		public splineMove.MoveState state;

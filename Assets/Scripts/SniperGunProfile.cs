...
public class SniperGunProfile : WeaponProfile
{
	public SniperGunProfile(string demo = "")
	{
		this.Total_Bullet_Profile = new IntProfileData("rambo.weapon.profile.totalbullet" + this.name + "1.0.4" + demo, 9999);
		...
		this.Gun_Value = new SniperValue();
	}

	private string name = "SniperGunProfile";
}

...
namespace EnhancedScrollerDemos.JumpToDemo
{
	public class Controller : MonoBehaviour, IEnhancedScrollerDelegate
	{
		...
		{
			int dataIndex;
			if (int.TryParse(this.jumpIndexInput.text, out dataIndex))
			{
				this.vScroller.JumpToDataIndex(dataIndex, this.scrollerOffsetSlider.value, this.cellOffsetSlider.value, this.useSpacingToggle.isOn, this.vScrollerTweenType, this.vScrollerTweenTime, null, EnhancedScroller.LoopJumpDirectionEnum.Down);
				this.hScroller.JumpToDataIndex(dataIndex, this.scrollerOffsetSlider.value, this.cellOffsetSlider.value, this.useSpacingToggle.isOn, this.hScrollerTweenType, this.hScrollerTweenTime, null, EnhancedScroller.LoopJumpDirectionEnum.Closest);
			}
			else
			{
				UnityEngine.Debug.LogWarning("The jump value you entered is not a number.");
			}
		}

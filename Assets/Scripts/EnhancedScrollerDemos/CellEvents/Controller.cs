...
namespace EnhancedScrollerDemos.CellEvents
{
	public class Controller : MonoBehaviour, IEnhancedScrollerDelegate
	{
		...
		{
			UnityEngine.Debug.Log("Cell Text Button Clicked! Value = " + value);
		}

		private void CellButtonFixedIntegerClicked(int value)
		{
			UnityEngine.Debug.Log("Cell Fixed Integer Button Clicked! Value = " + value);
		}

		private void CellButtonDataIntegerClicked(int value)
		{
			UnityEngine.Debug.Log("Cell Data Integer Button Clicked! Value = " + value);
		}
